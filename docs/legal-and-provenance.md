...
| [`legal-context.md`](../plugins/dpdpa-india/skills/dpdpa-india/references/legal-context.md) | Supreme Court judgments, IT Act 2000 + SPDI Rules 2011, CERT-In Directions, RBI directive, DPDP Act + Rules; cross-checked against the Latham & Watkins endnotes | Mixed primary sources |
...
- **Third-party commercial templates** - dpdpa.com is a commercial site. Its templates are **paraphrased and attributed, never mirrored**. Each template note in [`templates/README.md`](../plugins/dpdpa-india/skills/dpdpa-india/references/templates/README.md) captures only a template's purpose, the DPDP section/rule it satisfies, and a paraphrased clause checklist - explicitly "no verbatim template text." The site map repeats the rule: capture structure and purpose only, do not mirror template text.
...
- **SKILL.md footer** - the [skill playbook](../plugins/dpdpa-india/skills/dpdpa-india/SKILL.md) carries the same disclaimer so any harness that loads only the skill bundle still gets it.
