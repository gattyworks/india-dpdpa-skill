...
- Scope (entities, systems, data categories).
...
- Contact channels for queries/complaints.

**Audit signals**
- An internal policy document (repo `/docs`, wiki, or compliance folder) that staff can cite.
- A named DPO / privacy owner with contact details (required for SDFs).
- Evidence the principles are operationalized: minimization in schemas, access controls, encryption, logging.
- Links from this policy to the concrete artifacts (retention policy, breach runbook, DPIA records).
- Last-reviewed date and an owner.
