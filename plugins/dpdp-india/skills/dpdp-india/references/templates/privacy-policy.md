...
- Definitions of key terms (personal data, processing, Data Principal, Data Fiduciary).
- Categories of personal data collected and the collection methods.
- Purpose and lawful basis for each processing activity (purpose limitation).
