...
- Description of the breach: nature, timing, and circumstances; when/how detected.
- Categories of personal data and approximate number of principals affected.
- Likely consequences / risk to affected principals.
- Remedial and containment measures taken or planned.
- Recommended protective actions for affected individuals (e.g., reset credentials, monitor accounts).
- Contact point for affected individuals to seek information.
- Assurance of compliance and steps to prevent recurrence.
- Internal fields: incident reference, severity, Board reporting timestamp.
...
- A register of past breaches with reporting timestamps.
